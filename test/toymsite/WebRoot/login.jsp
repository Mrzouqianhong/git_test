...
<form action="/toymsite/toymsite?ac=login&a=a" method="post" name="f11" style="display: inline">
<table width="998" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="4" height="229" background="/toymsite/frontfiles/images/left.jpg">&nbsp;</td>
    ...
    <font color=gray>
      ...
      <tr>
        ...
        <input class=wenbenkuang name=pagerandom type=text value="" maxLength=4 size=3 />
           ...
           <img src="/toymsite/admin/ma.jsp" id="yzm" ></img> &nbsp; <span onClick="ma();" style="cursor: hand"  class="login_txt">换一张</span>
           <script type="text/javascript">
           function ma()
           {
           var a = document.getElementById("yzm");
           var myDate=new Date()
           a.src="/toymsite/admin/ma.jsp?d="+myDate;
           }
