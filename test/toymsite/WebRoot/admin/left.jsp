...
<script src="/toymsite/js/prototype.lite.js" type="text/javascript"></script>
<script src="/toymsite/js/moo.fx.js" type="text/javascript"></script>
<script src="/toymsite/js/moo.fx.pack.js" type="text/javascript"></script>
<style>
body {
...
H1 a {
	...
	background-image: url(/toymsite/frontfiles/images/menu_bgs.gif);
...
.MM a:link {
	...
	line-height: 26px;
	color: #333333;
	background-image: url(/toymsite/frontfiles/images/menu_bg1.gif);
	background-repeat: no-repeat;
	height: 26px;
	width: 182px;
	display: block;
    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content" style="display: ">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="/toymsite/frontfiles/images/menu_topline.gif" width="182" height="5" /></td>
          </tr>
        </table>
        <ul class="MM">  
          <li><a href="aordersjx.jsp" target="main">进行中的订单</a></li>
          <li><a href="lsaordersjx.jsp" target="main">历史订单</a></li> 
        </ul>
      </div>
      ...
      <div class="content" style="display: ">
        ...
        <li><a href="proscx.jsp" target="main">商品管理</a></li>
        ...
        <li><a href="newscx.jsp" target="main">新闻信息管理</a></li>
          ...
          <li><a href="splbcx.jsp" target="main">商品类别管理</a></li>  
      ...
      <div class="content" style="display: ">
        ...
        <ul class="MM">  
          ...
          <li><a href="lsordersjx.jsp" target="main">历史订单</a></li>
