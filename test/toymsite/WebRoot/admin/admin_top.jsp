...
function logout(){
	top.location = "/toymsite/index.jsp?z=z";
	return false;
}
</script>
  ...
  <tr>
    ...
    <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td width="26%" height="38" >
        <font color="white">&nbsp;&nbsp;&nbsp;&nbsp;
        <strong><font size=4>玩具商城信息服务中心</font></strong></font> </td>
      
        <td width="51%" height="38" class="admin_txt">
         
        
        <b><%=uname %> (<%=user.get("utype") %>)</b> 您好,感谢登陆使用！</td>
        <td width="22%"><a href="#" onClick="logout();" target="_self"><img src="/toymsite/frontfiles/images/out.gif" alt="安全退出" width="46" height="20" border="0"></a></td>
        <td width="4%">&nbsp;</td>
      </tr>
      <tr>
