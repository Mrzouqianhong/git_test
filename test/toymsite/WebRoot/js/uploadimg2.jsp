...
<LINK 
href="/toymsite/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/toymsite/admin/images/syscome.files/Admin.js"></SCRIPT>
<script type="text/javascript" src="/toymsite/js/popup.js"></script>
...
if(filename!=null)
{
 ...
 txt.src="/toymsite/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/toymsite/toymsite?ac=uploadimg2" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/toymsite/admin/kcfiles.jsp");
 <%}%>
 </script>
