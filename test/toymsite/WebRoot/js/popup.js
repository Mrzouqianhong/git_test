...
function uploadimg()
{
pop("/toymsite/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/toymsite/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/toymsite/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/toymsite/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/toymsite/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/toymsite/js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("/toymsite/js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("/toymsite/js/uploaddoc3.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/toymsite/js/dialogclose.gif  />';
